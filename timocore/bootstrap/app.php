...
use App\Http\Middleware\VerifyTokenProof;
...
return Application::configure(basePath: dirname(__DIR__))
    ->withRouting(
        ...
        using:function(){
            Route::namespace('App\Http\Controllers')->group(function(){
                ...
                Route::middleware(['web','maintenance'])->prefix('')->group(base_path('routes/user.php'));
            });
        }
    )
    ->withMiddleware(function (Middleware $middleware) {
        ...
        $middleware->group('api', [
            \App\Http\Middleware\AppendAppVersion::class,
        ]);
        ...
        $middleware->alias([
            ...
            'token.proof' => VerifyTokenProof::class,
            'admin' => RedirectIfNotAdmin::class,
            'admin.guest' => RedirectIfAdmin::class,

            'email.verified' => EmailMustVerify::class,
