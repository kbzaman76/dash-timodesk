        ...
        @forelse ($projectTasks as $projectTask)
            ...
            <li class="project-timer-item">
                <div class="project-timer-item-top">
                    <span class="title fw-bold">{{ $projectTask->project->title }}</span>
                    <br>
                    <span class="title">{{ $projectTask->title }}</span>
                </div>
                <div class="project-timer-item-bottom">
                    <div class="progress flex-grow-1">
                        <div class="progress-bar bg--base" style="width: {{ $timeInPercent }}%">
                        </div>
                    </div>
                    <span class="duration">{{ formatSeconds($projectTask->total_seconds) }}</span>
                </div>
            </li>
        @empty
            <li class="project-timer-item h-100">
                <div class="d-flex ms-auto text-center justify-content-center flex-column align-items-center h-100">
                    ...
                    <h6 class="project-empty-title">No task yet</h6>
                </div>
            </li>
        @endforelse
    </ul>
