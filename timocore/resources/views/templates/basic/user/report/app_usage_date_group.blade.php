<table class="activity-table-main">
    <thead>
        <tr>
            <th>@lang('Date')</th>
            <th class="date-heading" data-label="@lang('Member')"></th>
    ...
    <tbody>
        @forelse ($dates as $date)
            @php
                $collapseKey = 'date-group-' . $loop->index;
            @endphp
            <tr>
                <td colspan="100%">
                    <table class="table activity-table">
                        <tbody>
                                        ...
                                        <span class="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                                ...
                                                <path d="M3 10H21" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round"></path>
                                                <path opacity="0.4"
                                                    d="M12 14H12.01M12 18H12.01M16 14H16.01M8 14H8.01M8 18H8.01" stroke="currentColor"
                            ...
                            <tr class="collapse {{ $collapseKey }}" data-lazy="true" data-loaded="0" data-level="date_apps"
                                data-date="{{ $date->usage_date }}">
