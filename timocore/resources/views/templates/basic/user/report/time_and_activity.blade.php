        ...
        (function($) {
            ...
            $(document).ready(function() {
                ...
                function fetchLazyContent($collapse) {
                    ...
                    if (level === 'member_date_projects' || level === 'date_user_projects' || level === 'project_date_members') {
                ...
                $('.allContent').on('show.bs.collapse', '.collapse[data-lazy="true"]', function() {
                    ...
                    if ($collapse.data('loaded') || $collapse.data('loading')) {
                        if($collapse.data('level') == 'date_user_projects' || $collapse.data('level') == 'member_date_projects' || $collapse.data('level') == 'project_date_members'){
                            setProjectHeadingVisibility(true);
                        }
                        return;
                    }
