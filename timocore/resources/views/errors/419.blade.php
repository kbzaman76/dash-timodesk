...
@push('title')
    {{ gs()->siteName($pageTitle ?? '419 | Page Expired') }}
@endpush
...
@section('content')
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
            ...
            <h2 class="title text--base"> @lang('Page Expired')</h2>
            <p class="description">@lang('Your session has timed out or the page has expired. Please refresh the page or try your request again.')</p>
