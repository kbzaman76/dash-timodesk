...
@push('title')
    {{ gs()->siteName($pageTitle ?? '413 | Request Entity Too Large') }}
@endpush
@section('content')
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
            ...
            <h2 class="title text--base"> @lang('Request Entity Too Large')</h2>
            <p class="description">@lang('The file or data you’re trying to upload exceeds the allowed limit. Please reduce the file size and try again.')</p>
