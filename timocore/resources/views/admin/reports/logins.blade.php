                        ...
                        <table class="table table--light style--two">
                            ...
                            @forelse($loginLogs as $log)
                                ...
                                <td>
                                    ...
                                    <br>
                                    <span class="small"> <a href="{{ route('admin.users.detail', $log->user_id) }}"><span>@</span>{{ $log->user?->fullname }}</a> </span>
                                </td>
...
@push('breadcrumb-plugins')
    @if(request()->routeIs('admin.report.login.history'))
        <x-search-form placeholder="Search fullname" dateSearch='yes' />
    @endif
@endpush
