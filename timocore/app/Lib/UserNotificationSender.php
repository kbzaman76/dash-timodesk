 ...
 * It supports multiple notification channels (e.g., email notifications) and manages
...
class UserNotificationSender
{
    ...
    public function notificationToAll($request)
    {
        ...
        $this->sendNotifications($users, $request);
    ...
    public function notificationToSingle($request, $userId)
    {
        ...
        $this->sendNotifications($user, $request,  true);
