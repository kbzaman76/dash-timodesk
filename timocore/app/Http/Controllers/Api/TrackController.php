...
class TrackController extends Controller
{
    ...
    public function storeTrack(Request $request)
    {
        ...
        if (json_last_error() !== JSON_ERROR_NONE || !is_array($appsPayload)) $appsPayload = null;
        ...
        try {
            $track = DB::transaction(function () use (
                $data, $userId, $startedAt, $endedAt, $timeInSeconds,
                $overallToStore, $mouseCounts, $keyboardCounts, $activityPct, $appsPayload
            ) {
                $track                      = new Track();
    ...
    private function insertAppData($track, $appsPayload) {
        $appsData = [];
